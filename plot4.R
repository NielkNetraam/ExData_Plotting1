...
# Global Active Power
with(hpcs, plot(Timestamp, Global_active_power, type = "l", xlab="", ylab = "Global Active Power (kilowatts)"))
...
# Voltage
with(hpcs, plot(Timestamp, Voltage, type = "l", xlab="datetime"))

# Global_reactive_power
with(hpcs, plot(Timestamp, Global_reactive_power, type = "l", xlab="datetime"))
